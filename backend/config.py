...
IOTHUB_CONNECTION_STRING = os.getenv("IOT_CONNECTION", "NO_IOT_CONNECTION_STRING")
EVENTHUB_CONNECTION_STRING = os.getenv(
    "EVENTHUB_CONNECTION", "NO_EVENTHUB_CONNECTION_STRING"
)
...
EXTERNAL_API_URL = os.getenv("EXTERNAL_API_URL", "PLEASE SET THIS NEW API URL")
